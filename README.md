...
| v0.3    | Approval-gate primitive (step pause state now landed), hashed one-time resume/reject tokens, CLI/API resume controls, and signed webhook outbox delivery.                                                                                                             | Q4 2026           |
