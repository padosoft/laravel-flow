...
| Macro Task 2 - v0.2 persistence layer | In progress. Persistence migrations/repositories, synchronous engine wiring, and retention pruning have landed on the macro branch; correlation/idempotency behavior is the active slice being finalized through the PR loop. |
