...
- `composer validate --strict --no-check-publish`
- `composer quality` => Pint format test, PHPStan, Unit 113 tests / 479 assertions, Architecture 2 tests / 7 assertions
