...
- `composer validate --strict --no-check-publish`
- `composer quality` => Pint format test, PHPStan, Unit 182 tests / 836 assertions, Architecture 2 tests / 7 assertions
