...
- `composer validate --strict --no-check-publish`
- `composer quality` => Pint format test, PHPStan, Unit 204 tests / 914 assertions, Architecture 2 tests / 7 assertions
