...
| Macro Task 2 - v0.2 persistence layer | In progress; persistence foundation is landing for storage contracts, schema, repositories, timestamped atomic step upserts, append-only audit records, and payload redaction. |
