...
- `composer validate --strict --no-check-publish`
- `composer quality` => Pint format test, PHPStan, Unit 167 tests / 763 assertions, Architecture 2 tests / 7 assertions
