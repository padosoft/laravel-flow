...
| Macro Task 2 - v0.2 persistence layer | In progress; first slice adds publishable migrations, persistence contracts, Eloquent repositories, append-only audit records, and payload redaction. |
