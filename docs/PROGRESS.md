...
| Macro Task 2 - v0.2 persistence layer | In progress. Persistence migrations/repositories and synchronous engine wiring have landed on the macro branch; current subtask branch `task/persistence-prune-command` adds the retention pruning slice. |
