...
- `composer validate --strict --no-check-publish`
- `composer quality` => Pint format test, PHPStan, Unit 193 tests / 873 assertions, Architecture 2 tests / 7 assertions
