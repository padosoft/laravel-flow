...
| Macro Task 1 - baseline tooling and Laravel 13 policy | In progress on subtask branch `task/laravel13-composer-ci`; Composer/CI/docs now narrow to Laravel 13, PHP 8.3/8.4, and Composer-script quality gates. Copilot's CONTRIBUTING validate-step drift comments were fixed; local gates passed on PHP 8.4.20 with PHPUnit 12.5.24. |
