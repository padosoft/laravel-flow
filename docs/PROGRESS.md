...
- `composer validate --strict --no-check-publish`
- `composer quality` => Pint format test, PHPStan, Unit 205 tests / 924 assertions, Architecture 2 tests / 7 assertions
