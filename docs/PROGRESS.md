...
- `composer validate --strict --no-check-publish`
- `composer quality` => Pint format test, PHPStan, Unit 185 tests / 842 assertions, Architecture 2 tests / 7 assertions
