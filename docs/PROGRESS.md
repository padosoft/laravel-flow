...
| Macro Task 1 - baseline tooling and Laravel 13 policy | In progress on subtask branch `task/laravel13-composer-ci`; Composer/CI/docs now narrow to Laravel 13, PHP 8.3/8.4, and Composer-script quality gates. |
