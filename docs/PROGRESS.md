...
- `composer validate --strict --no-check-publish`
- `composer quality` => Pint format test, PHPStan, Unit 176 tests / 799 assertions, Architecture 2 tests / 7 assertions
